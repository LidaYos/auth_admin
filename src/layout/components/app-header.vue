    ...
    <div class="page">
        <div class="page__left">
            ...
            <el-breadcrumb separator="/">
                <el-breadcrumb-item v-for="item in breadcrumb" :key="item.id" :to="item.router">
                    {{ item.name }}
                </el-breadcrumb-item>
            </el-breadcrumb>
        ...
        <div class="page__right">
            ...
            <el-dropdown>
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item @click="handleRouteClear">个人中心</el-dropdown-item>
...
const breadcrumb = computed(() => {
    ...
    // 从权限中，找到与当前路由路径匹配的
    const menu = menus?.find(item => item.router === router.currentRoute.value.path)
    // 不存在，则显示 首页
    if (!menu) {
    ...
    // 在前面 添加一个首页
    list.unshift({ id: 0, name: "首页", router: "/" })
    return list
})
